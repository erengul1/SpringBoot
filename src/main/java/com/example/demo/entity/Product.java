...
public class Product {
    ...
    @Column(name = "product_barcodeNumber")
    private String product_barcodeNumber;

    @Column(name = "product_is_favourited")
    ...
    public Product(String product_name, float product_price, String product_imageURL, int product_count, String product_barcodeNumber, boolean product_is_favourited) {
        this.product_name = product_name;
        this.product_price = product_price;
        this.product_imageURL = product_imageURL;
        this.product_count = product_count;
